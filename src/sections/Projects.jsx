...
import { myProjects } from "../constan/index.js";
...
const Projects = () => {
    ...
    const textureFileName = useMemo(() => {
        return currentProject.texture?.split("/").pop()?.toLowerCase() || "";
    }, [currentProject.texture]);

    const isTabletTexture = textureFileName === "tablet1.mp4";
    const isComputerTexture = /^project\d+\.mp4$/.test(textureFileName);
                    ...
                    <Canvas>
                        ...
                        <Center>
                            <Suspense fallback={<CanvasLoader />}>
                                {isTabletTexture ? (
                                    <group scale={2.2} position={[0, -2.2, 0]} rotation={[0, -1.6, 0]}>
                                        <DemoTablet texture={currentProject.texture} />
                                    </group>
                                ) : isComputerTexture ? (
