...
export const calculateSizes = (isSmall, isMobile, isTablet) => {
    return {
        ...
        controllerPosition: isSmall ? [-8, 2.5, 0] : isMobile ? [-9, 3, 0] : isTablet ? [-10.5, 3.5, 0] : [-12, 4, 0],
        controllerScale: isSmall ? 0.008 : isMobile ? 0.012 : isTablet ? 0.015 : 0.02,
        charmanderPosition: isSmall ? [-5, -8, -10] : isMobile ? [-9, -8, -10] : isTablet ? [-11, -5, -10] : [-13, -11, -10],
    };
};
...
export const workExperiences = [
    {
        ...
        duration: '2024 - 2025',
        title: "Developed a real-time Android driver roster and tracking app, improving efficiency by 15%. Implemented map tracking with Mapsforge and MQTT, including offline support and fast network recovery. Worked in an Agile team and used AI tools to improve development speed and code quality.",
        icon: '/assets/android.png',
        animation: 'victory',
    },
    {
        id: 2,
        name: 'Prestige IT Solutions',
        pos: 'Web Developer',
        duration: '2023 - 2024',
        title: "Developed and maintained responsive websites using WordPress, HTML, CSS, JavaScript, and PHP. Fixed daily tickets, improved SEO and performance, and ensured cross-browser compatibility. Collaborated with team members and stakeholders in an Agile environment.",
    ...
    },
    {
        ...
        pos: 'Bachelor of Engineering (Honours) - Software Engineering',
        duration: '2020 - 2024',
        title: "Graduated with a Bachelor of Engineering (Honours) in Software Engineering. Awarded Top Graduand. Active member of Devs (Developer Society) and WDCC (Web Development and Consulting Club).",
        icon: '/assets/aut.svg',
        animation: 'salute',
    },
];